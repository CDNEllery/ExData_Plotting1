...
# Multiple grpahs on one plot
        # Adjust to put multiple graphs on one plot
        par(mfcol = c(2,2))
        # Insert Plot2.R
        ...
        # Develop Voltage plot
        with(required_dates, plot(Date_Time, Voltage, xlab = "datetime", ylab = "Voltage", type = "l"))
        # Develop Global Reactive Power plot
        with(required_dates, plot(Date_Time, Global_reactive_power, xlab = "datetime", type = "l"))
